...
export async function validateProjectFile(input: string): Promise<string> {
...
export async function openProjectFile(request: OpenProjectFileRequest): Promise<Record<string, unknown>> {
